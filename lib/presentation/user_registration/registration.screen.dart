          ...
          child: Column(
            children: [
                    ...
                    : Row(
                        children: [
                              ...
                              onDateTap: controller.isEditing
                                  ...
                                  : () {
                                      Get.toNamed(Routes.SEARCH_SCREEN,
                                              arguments: controller.houseData)
                                          ?.then((onValue) {
                                        controller.houseNameController.text =
                                            onValue.name != null
                          ...
                          controller.isEditing
                              ...
                              : Obx(
                                  () => !controller.isHouseDataSuccessful.value
                                      ? IconButton(
                                          onPressed: () {
              ...
              CommonDropdownFormFieldWidget(
                ...
                selectedValue: controller.genderController.text.isEmpty
                    ? null
              ...
              CommonTextFormField(
                ...
                onFieldSubmitted: (value) {
                  FocusScope.of(context).requestFocus(controller.ageFocusNode);
                },
                onDateTap: () async {
                  FocusScope.of(context).requestFocus(FocusNode());
              ...
              CommonTextFormField(
                  ...
                  enabled: controller.dobController.text.trim().isNotEmpty
                      ? false
                      : true,
                  disabledLabelColor:
              ...
              CommonDropdownFormFieldWidget(
                ...
                selectedValue: controller.incomeController.text.isEmpty
                    ? null
                  ...
                  Obx(
                    () => Checkbox(
                      ...
                      onChanged: (bool? value) {
                        controller.isWillingToDonate.value = value ?? false;
                      },
                    ),
                  ),
                  CommonTextWidget(
              ...
              Obx(() => controller.isExpat.value
                  ? CommonTextFormField(
                      ...
                      onDateTap: () {
                        Get.toNamed(Routes.SEARCH_SCREEN,
                                arguments: Utilities.getCountryList(context))
                            ?.then((onValue) {
